...
namespace DelegatesEvents.Beispiele.WithDelegates {
    ...
    public class CallbacksWithDelegateTest {
        public static void Test() {
            ...
            // Observers anmelden 
            c1.add_OnTickEvent(t1.InstanceClockTicked);
            c1.add_OnTickEvent(ClockObserver.StaticClockTicked);
            c2.add_OnTickEvent(t2.InstanceClockTicked);
            c2.add_OnTickEvent(ClockObserver.StaticClockTicked);
            ...
            // Observers abmelden 
            c1.remove_OnTickEvent(t1.InstanceClockTicked);
            c2.remove_OnTickEvent(t2.InstanceClockTicked);
        }
    }
